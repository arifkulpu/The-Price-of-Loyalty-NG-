...
*   **Bribe-Based Dynamic Level Scaling:** Recruited teammates dynamically scale their levels to match the size of your payment. Offering a low bribe recruits an apprentice-tier combatant (randomly leveled between 1 and 10). Offering a high bribe recruits an elite-tier combat veteran (ranging from level 10 up to your player level + 5), making investment in high-tier bribes extremely rewarding.
...
*   **Rüşvet Miktarına Göre Seviye Ölçeklemesi (Level Scaling):** İşe aldığın müttefiklerin seviyeleri doğrudan yaptığın ödemenin büyüklüğüne göre ölçeklenir. Düşük rüşvet teklif edersen çırak seviyesinde yoldaşlar (1 ile 10 lvl arası rastgele) kazanırsın. Yüksek rüşvet teklif edersen, elit sınıfta savaş veteranları (10 seviyeden başlayıp oyuncunun seviyesinin +5 üstüne kadar ölçeklenen) kazanırsın. Cömert ödemeler yapmak artık çok daha avantajlı ve hissettiricidir!
